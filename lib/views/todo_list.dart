    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Text("Shared Todos"),
          // Expanded(
          //   child: Column(
          //     children: [
          //       for (int i = 0; i < todoController.list.length; i++)
          //         CustomList(
          //             query: ref
          //                 .orderByChild('id')
          //                 .equalTo(todoController.list[i]),
...
//           },
//           itemBuilder: (context, snapshot, animation, index) {
//             if (snapshot.child('isActive').value != null) {
//               return ListTile(
//                 // title: Text((snapshot.child('todo').value.toString())),
//                 title: Text(snapshot.child('todo').value.toString()),
//                 leading: Checkbox(
...
//                               onTap: () {
//                                 Navigator.pop(context);
//                                 todoController.navigateToEdit(snapshot, ref);
//                               },
//                               leading: const Icon(Icons.edit),
//                               title: const Text('Edit'),
//                             ),
...
//                             child: ListTile(
//                               onTap: () async {
//                                 todoController.navigateToShare(snapshot, ref);
//                               },
//                               leading: const Icon(Icons.share),
//                               title: const Text('Share'),
//                             ),
...
//               );
//             } else {
//               return const Text("no shared todo");
//             }
//           }),
//     );
//   }
